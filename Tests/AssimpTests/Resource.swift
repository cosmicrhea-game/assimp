...
enum Resource: String {
  ...
  case duck_dae =
    "https://raw.githubusercontent.com/assimp/assimp/master/test/models/Collada/duck.dae"
  ...
  case busterDrone_gltf =
    "https://gitlab.com/ctreffs/assets/raw/master/models/buster_drone/scene.gltf"
  case airplane_usdz =
    "https://developer.apple.com/augmented-reality/quick-look/models/biplane/toy_biplane.usdz"
  case boxTextured_gltf =
    "https://raw.githubusercontent.com/assimp/assimp/master/test/models/glTF2/BoxTextured-glTF/BoxTextured.gltf"
  case cubeDiffuseTextured_3ds =
    "https://github.com/assimp/assimp/raw/master/test/models/3DS/cube_with_diffuse_texture.3DS"
  case damagedHelmet_glb =
    "https://github.com/KhronosGroup/glTF-Sample-Models/raw/master/2.0/DamagedHelmet/glTF-Binary/DamagedHelmet.glb"
  case cesiumMan_glb =
    "https://github.com/KhronosGroup/glTF-Sample-Models/raw/master/2.0/CesiumMan/glTF-Binary/CesiumMan.glb"
  ...
  static func load(_ resource: Resource) throws -> URL {
    ...
    var name: String = remoteURL.pathComponents.reversed().prefix(3).reversed().joined(
      separator: "_")
    name.append(".")
