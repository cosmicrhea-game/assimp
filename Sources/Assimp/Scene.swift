...
public final class Scene {
  ...
  init(scenePtr: UnsafePointer<aiScene>, filePath: String) throws {
  ...
  public lazy var animations: [Animation] = UnsafeBufferPointer(
    start: scenePtr.pointee.mAnimations, count: numberOfAnimations
  ).compactMap { ptr in
    guard let a = ptr?.pointee else { return nil }
    return Animation(a)
  }
