...
public struct PostProcessStep: OptionSet {
  ...
  public static let calcTangentSpace = PostProcessStep(
    rawValue: aiProcess_CalcTangentSpace.rawValue)
  ...
  public static let fixInfacingNormals = PostProcessStep(
    rawValue: aiProcess_FixInfacingNormals.rawValue)
  ...
  public static let flipWindingOrder = PostProcessStep(
    rawValue: aiProcess_FlipWindingOrder.rawValue)
  ...
  public static let genSmoothNormals = PostProcessStep(
    rawValue: aiProcess_GenSmoothNormals.rawValue)
  ...
  public static let improveCacheLocality = PostProcessStep(
    rawValue: aiProcess_ImproveCacheLocality.rawValue)
  ...
  public static let joinIdenticalVertices = PostProcessStep(
    rawValue: aiProcess_JoinIdenticalVertices.rawValue)
  ...
  public static let limitBoneWeights = PostProcessStep(
    rawValue: aiProcess_LimitBoneWeights.rawValue)
  ...
  public static let preTransformVertices = PostProcessStep(
    rawValue: aiProcess_PreTransformVertices.rawValue)
  ...
  public static let removeRedundantMaterials = PostProcessStep(
    rawValue: aiProcess_RemoveRedundantMaterials.rawValue)
  ...
  public static let splitByBoneCount = PostProcessStep(
    rawValue: aiProcess_SplitByBoneCount.rawValue)
  ...
  public static let splitLargeMeshes = PostProcessStep(
    rawValue: aiProcess_SplitLargeMeshes.rawValue)
  ...
  public static let transformUVCoords = PostProcessStep(
    rawValue: aiProcess_TransformUVCoords.rawValue)
  ...
  public static let validateDataStructure = PostProcessStep(
    rawValue: aiProcess_ValidateDataStructure.rawValue)
}
